...
public class EditProductDetails extends AppCompatActivity {
    ...
    private String productId="",checker="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfilePictureRef= FirebaseStorage.getInstance().getReference().child("Product image");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        else
        {
            ...
            startActivity(new Intent(EditProductDetails.this,EditProductDetails.class));
            finish();
        }
    }
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(EditProductDetails.this,"Product Updated",Toast.LENGTH_SHORT).show();
        finish();
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if(task.isSuccessful())
                            {
                                ...
                                startActivity(new Intent(EditProductDetails.this,HomeActivity.class));

                                Toast.makeText(EditProductDetails.this,"Profile Updated",Toast.LENGTH_SHORT).show();
                                finish();
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(EditProductDetails.this,"Error",Toast.LENGTH_SHORT).show();
